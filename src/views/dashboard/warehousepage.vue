  ...
  <div class="gitlabmanager" @click="onBlur" >
    <div class="gitlabmanager-right">
      <div class="gitlabmanager-right-search">
        <div class="gitlabmanager-right-search-left"><el-page-header :content="headtitle" title=" " @back="goBack" /></div>
...
.el-page-header .el-page-header__content,.el-page-header .el-page-header__left{
    font-size: 20px;
    color: #4B4B4B;
}
